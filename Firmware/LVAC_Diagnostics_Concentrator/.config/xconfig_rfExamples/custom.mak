...
linker.cmd: package/cfg/rfExamples_pem3.xdl
	$(SED) 's"^\"\(package/cfg/rfExamples_pem3cfg.cmd\)\"$""\"F:/ccsv6/IoT_wkspc/Project_LVAC/Firmware/LVAC_Diagnostics_Concentrator/.config/xconfig_rfExamples/\1\""' package/cfg/rfExamples_pem3.xdl > $@
